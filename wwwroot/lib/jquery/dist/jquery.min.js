$(document).ready(function () {
    ...
    $('#nominas').on('click', '.select-row', function () {
        $(this).closest('tr').addClass('selected-row');
    ...
    $('#nominas').on('click', '.excel', function () {
        var peTipo = $('#peTipo').val();
        var peAnio = $('#peAnio').val();
        var peNumero = $('#teNumeroPeriodo').val();
        if (peNumero) {
    ...
    $('#nominas').on('click', '.download', function () {
        // Añade la clase a la fila seleccionada
        $(this).closest('tr').addClass('selected-row');
    ...
    $('#nominas').on('click', '.nominas', function () {
        var peTipo = $('#peTipo').val();
        var peAnio = $('#peAnio').val();
        var peNumero = $('#teNumeroPeriodo').val();
        ...
        var url = '/Home/NominaRequest?peAnio=' + peAnio + '&peTipo=' + peTipo + '&peNumero=' + peNumero;
